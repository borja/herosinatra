...
def guardians
  [
    { :id               => 0,
      ...
      :unión            => 'No aporta habilidades especiales',
    ...
    { :id               => 4,
      ...
      :unión            => 'El poseído puede ejecutar mordisco y carga',
    ...
    { :id               => 7,
      ...
      :sabiduría        => 'Vista nocturna(recupera magias de sus compañeros con 5+)/ Vista nocturna (facilidad para ver seres ocultos, sombras, niebla) y Huevo de Oro (al morir, se convierte en un huevo de oro de 1PC)',

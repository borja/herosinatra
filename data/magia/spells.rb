...
def spells
  [
    ...
    Magia.new({ 
      :id           => 29,
      :name         => "infierno",
      :efecto       => "En 1 casilla, ataque igneo de dados =mente del conjurador/2. Las casillas contiguas reciben 2. Magia sacrificada= +1 casilla de fuego.",
    ...
    Magia.new({ 
      :id           => 57,
      :name         => "desvío",
      :efecto       => "Magia instantánea. Cualquier proyectil, o trampa flecha, queda anulada. El mago puede elegir perder 2 PM y recuperar el hechizo una única vez.",

...
def enchants
  [
    ...
    { :id           => 24,
      ...
      :descripcion  => "Permite controlar la magia de la estación de la primavera, de la estación del verano, de la estación del otoño y de la estación del invierno.",
      :tipo         => "natura",
    },
    { :id           => 25,

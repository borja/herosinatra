...
def heros
  [
    ...
    Hero.new({ 
      ...
      :armas        => [{:id => 9,  :gemas    => [25,17,26], :enchants => [18,1,2,3,4,17]},
                        {:id => 23, :joyas    => [14,18,15], :enchants => [23,24]}],
    ...
    Hero.new({ 
      ...
      :skills       => [0,1,2,5],
      :armas        => [{:id => 3,  :enchants => [54]}, 
                        {:id => 4,  :enchants => [13,14,15] }],
      :armaduras    => [{:id => 1,  :gemas    => [4,4,4]}],
      :proteccions  => [{:id => 1,  :enchants => [55]}, 
                        {:id => 3,  :gemas    => [26],     :ranuras => 1}, 
                        {:id => 8,  :gemas    => [29]}],
      :miscelaneas  => [{:id => 1,  :gemas    => [19],     :enchants => [56] }, 
                        {:id => 2,  :gemas    => [28]},
                        {:id => 6,  :enchants => [57]}],
    }),
    Hero.new({ 
    ...
    Hero.new({ 
      ...
      :mov          => 9,
      :armas        => [{:id => 7}, 
                        {:id => 9,  :gemas    => [25,17,26], :enchants => [1,2,3,4,17,18]}],
      :armaduras    => [{:id => 6, :gemas    => [32]}],
    ...
    Hero.new({ 
      ...
      :armas        => [{:id => 10, :gemas  => [11,11]}, 
                        {:id => 7,  :gemas  => [29,32]}],
      :armaduras    => [{:id => 3,  :gemas  => [34]}],
      :proteccions  => [{:id => 1,  :enchants => [20]},
                        {:id => 2,  :joyas  => [3]}, 
                        {:id => 8,  :joyas  => [1,1], :gemas  => [24]}],
      :miscelaneas  => [{:id => 1},
                        {:id => 2},
                        {:id => 13,  :enchants => [36]},
                        {:id => 8}],
...
def mundano?(item)
  item[:gemas].nil? && item[:joyas].nil? && item[:runas].nil? && item[:ranuras].nil?
end
